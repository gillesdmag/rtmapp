...
class Firestore {
  ...
  // just a simple get
  static Future<List<AppUserData>> getAllEntries(String collection) async {
    return (await FirebaseFirestore.instance.collection(collection).get())
        .docs
        .map((item) => AppUserData.fromMap(item.data()))
        .toList();
  }

  // get with custom order
  static Future<List<AppUserData>> getAllEntriesSortedByName(
  ...
  // get with filter
  static Future<List<AppUserData>> getAllEntriesFilteredByPrice(
      String collection) async {
    return (await FirebaseFirestore.instance
            .collection(collection)
